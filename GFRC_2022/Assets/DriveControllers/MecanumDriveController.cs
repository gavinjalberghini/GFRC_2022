...
public class MecanumDriveController : DriveController
{
	...
	public override void control(Vector2 translation, float steering)
	{
		...
		wheel_front_left .power = translation.x + translation.y + steering;
		wheel_front_right.power = translation.y - translation.x - steering;
	}
}
